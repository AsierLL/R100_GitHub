...
extern void thread_core_create(void);
extern void thread_drd_create(void);
extern void thread_patMon_create(void);
extern void thread_hmi_create(void);
extern void thread_sysMon_create(void);
extern void thread_recorder_create(void);
extern void thread_audio_create(void);
extern void thread_defibrillator_create(void);
extern void thread_comm_create(void);
extern void thread_dummy_create(void);
extern void thread_acc_create(void);
