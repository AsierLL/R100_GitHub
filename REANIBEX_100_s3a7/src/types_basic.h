...
#define MAX_UNIT32_T        0xFFFFFFFF
...
#define OSTIME_800MSEC          (OSTIME_10MSEC * 80)        ///< 800 msecs
...
#define OSTIME_40SEC            (OSTIME_10MSEC * 4000)      ///< 40 secs
#define OSTIME_50SEC            (OSTIME_10MSEC * 5000)      ///< 50 secs
#define OSTIME_60SEC            (OSTIME_10MSEC * 6000)      ///< 60 secs
#define OSTIME_70SEC            (OSTIME_10MSEC * 7000)      ///< 70 secs
