...
/*                                            added a new error for       */
/*                                            renegotiation issues and    */
/*                                            changed the name of the     */
/*                                            SCSV renegotiation flag,    */
/*                                            added new error return for  */
...
/*  11-01-2018     Timothy Stapko           Modified comment(s),          */
...
#define NETX_SECURE_MINOR_VERSION                      11
#define NETX_SECURE_SERVICE_PACK_VERSION                2
...
typedef struct NX_SECURE_TLS_SESSION_STRUCT
{
    ...
    /* Chosen ciphersuite. */
    USHORT nx_secure_tls_session_ciphersuite;
