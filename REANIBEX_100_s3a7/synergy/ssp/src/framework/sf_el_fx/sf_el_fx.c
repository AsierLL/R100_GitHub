 ...
 *                                                      * @ref sf_el_fx_driver_request_handler
 **********************************************************************************************************************/
...
void  SF_EL_FX_BlockDriver (FX_MEDIA * p_fx_media)
{
    ...
    /** - Pass control to @ref sf_el_fx_driver_request_handler, which is responsible for setting
 ...
 *                              * @ref sf_el_fx_driver_release_sectors_handler
 *                              * @ref sf_el_fx_driver_init_handler
 *                              * @ref sf_el_fx_driver_boot_read_handler
 *********************************************************************************************************************/
static ssp_err_t sf_el_fx_driver_request_handler(FX_MEDIA * p_fx_media)
{
    ssp_err_t                   ret_val       = SSP_SUCCESS;
