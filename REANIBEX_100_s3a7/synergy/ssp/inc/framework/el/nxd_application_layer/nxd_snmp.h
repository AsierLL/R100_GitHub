...
UINT    _nx_snmp_utility_octet_get(UCHAR *buffer_ptr, UCHAR *octet_string, UINT *octet_length, INT buffer_length);
...
UINT    _nx_snmp_utility_tlv_block_parse(UCHAR *buffer, USHORT *tlv_type, USHORT *tlv_tag_class, ULONG *tlv_length, UCHAR **tlv_data, ULONG *header_length);
