...
//#define UNITY_OUTPUT_CHAR(a)       Comm_Send_Char(a)
//#define UNITY_OUTPUT_CHAR(a)       Trace_Char(a)
#define UNITY_OUTPUT_CHAR(a)         Trace_Test(a)
...
void Comm_Send_Char(int data_to_send)
{
/*  Trace_Char(data_to_send); */

/*
    static char trace_buffer[256];              // buffer used to write traces
    static int i = 0;

    trace_buffer[i] = data_to_send;
    i++;
    if((data_to_send == '\n') || (i >= 254))
    {
        Trace (0, trace_buffer);
